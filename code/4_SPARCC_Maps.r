...
# save map
htmlwidgets::saveWidget(atlanta, file="~/git/sparcc/maps/atlanta_3_noliaffordmoversloss.html")
...
# save map
htmlwidgets::saveWidget(chicago, file="~/git/sparcc/maps/chicago_3_noliaffordmoversloss.html")
...
# # save map
htmlwidgets::saveWidget(denver, file="~/git/sparcc/maps/denver_3_noliaffordmoversloss.html")
...
# # save map
htmlwidgets::saveWidget(memphis, file="~/git/sparcc/maps/memphis_3_noliaffordmoversloss.html")
