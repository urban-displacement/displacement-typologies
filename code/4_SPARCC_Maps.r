...
# save map
htmlwidgets::saveWidget(atlanta, file="~/git/sparcc/maps/atlanta_5_noaffordmoversloss.html")
...
# save map
htmlwidgets::saveWidget(chicago, file="~/git/sparcc/maps/chicago_5_noaffordmoversloss.html")
...
# # save map
htmlwidgets::saveWidget(denver, file="~/git/sparcc/maps/denver_5_noaffordmoversloss.html")
...
# # save map
htmlwidgets::saveWidget(memphis, file="~/git/sparcc/maps/memphis_5_noaffordmoversloss.html")
