...
# save map
htmlwidgets::saveWidget(atlanta, file="~/git/sparcc/maps/atlanta_4_noaffordmovers.html")
...
# save map
htmlwidgets::saveWidget(chicago, file="~/git/sparcc/maps/chicago_4_noaffordmovers.html")
...
# # save map
htmlwidgets::saveWidget(denver, file="~/git/sparcc/maps/denver_4_noaffordmovers.html")
...
# # save map
htmlwidgets::saveWidget(memphis, file="~/git/sparcc/maps/memphis_4_noaffordmovers.html")
