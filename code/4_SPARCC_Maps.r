...
# save map
htmlwidgets::saveWidget(atlanta, file="~/git/sparcc/maps/atlanta_7_nodensitylilossaffordlimove.html")
...
# save map
htmlwidgets::saveWidget(chicago, file="~/git/sparcc/maps/chicago_7_nodensitylilossaffordlimove.html")
...
# # save map
htmlwidgets::saveWidget(denver, file="~/git/sparcc/maps/denver_7_nodensitylilossaffordlimove.html")
...
# # save map
htmlwidgets::saveWidget(memphis, file="~/git/sparcc/maps/memphis_7_nodensitylilossaffordlimove.html")
