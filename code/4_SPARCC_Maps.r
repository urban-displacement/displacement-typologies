...
# save map
htmlwidgets::saveWidget(atlanta, file="~/git/sparcc/maps/atlanta_2_noliaffordmovers.html")
...
# save map
htmlwidgets::saveWidget(chicago, file="~/git/sparcc/maps/chicago_2_noliaffordmovers.html")
...
# # save map
htmlwidgets::saveWidget(denver, file="~/git/sparcc/maps/denver_2_noliaffordmovers.html")
...
# # save map
htmlwidgets::saveWidget(memphis, file="~/git/sparcc/maps/memphis_2_noliaffordmovers.html")
